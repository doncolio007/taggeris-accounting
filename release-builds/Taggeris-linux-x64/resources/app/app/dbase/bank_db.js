...
db.bank_ledger.find({}, function(err, data) {
  ...
  for (x in data){
    ...
    document.getElementById("bank-list").innerHTML += "<tr><td>"+ data[x].date +"</td><td>"+data[x].particulars+"</td><td>"+ data[x].lf+"</td><td class="+drClass+">"+debit+"</td><td class="+crClass+">"+credit+"</td>";   
   }
